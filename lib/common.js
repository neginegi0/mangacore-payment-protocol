...
var Signature = mangacore.crypto.Signature;
var ECDSA = mangacore.crypto.ECDSA;
var sha256sha256 = mangacore.crypto.Hash.sha256sha256;
var varintBufNum = mangacore.encoding.BufferWriter.varintBufNum;
...
PaymentProtocol.LEGACY_PAYMENT.BTC.REQUEST_CONTENT_TYPE = 'application/mangacoin-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.BTC.CONTENT_TYPE = 'application/mangacoin-payment';
PaymentProtocol.LEGACY_PAYMENT.BTC.ACK_CONTENT_TYPE = 'application/mangacoin-paymentack';

PaymentProtocol.LEGACY_PAYMENT.BCH.REQUEST_CONTENT_TYPE = 'application/mangacoincash-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.BCH.CONTENT_TYPE = 'application/mangacoincash-payment';
PaymentProtocol.LEGACY_PAYMENT.BCH.ACK_CONTENT_TYPE = 'application/mangacoincash-paymentack';
...
function magicHash(str) {
  var magicBytes = new Buffer('Mangacoin Signed Message:\n');
